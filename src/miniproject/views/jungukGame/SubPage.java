...
public class SubPage extends JPanel {
	...
	private Image quest = new ImageIcon("images/Q1.PNG").getImage().getScaledInstance(1000, 700, 0);
	private ImageIcon bg = new ImageIcon("images/bg1.PNG");
...
//		label.setLocation(0,100);
		...
		this.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				ChangePanel.changePanel(mf, panel, new GamePanel());
