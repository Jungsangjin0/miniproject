...
public class MainMap6 extends JPanel {	
	private int donum;
	MainFrame mf;
	MainMap6 panel = this;
	private Door[] doors = {new Door(), new Door(), new Door(), new Door(), new Door(), new Door(), new Door()};
...
//	this.doors[5].setBounds(870, 0, 10, 900); 
	...
	this.doors[6].setLayout(null); //돌발
	this.doors[6].setBounds(500, 0, 10, 900); 
...
//		}
//	});
	doors[6].addMouseListener(new MouseAdapter() {
