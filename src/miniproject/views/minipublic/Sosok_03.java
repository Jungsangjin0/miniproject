...
public class Sosok_03 extends JPanel { //사장님한테 미션받는 장면(캐릭터가 다가가서
   ...
   public Sosok_03(MainFrame mf, Player123 player) {
   ...
   public void paintComponent(Graphics g) {
      ...
      g.drawString("사장님 : 전국노래자랑에 나가려면 노래와 춤 능력치를 1씩 올려오시게나", 100, 700);
      g.drawString("노래연습장은 왼쪽문이고, 춤연습장은 오른쪽문이니 순서대로 능력치를 올려보게", 100, 750);
