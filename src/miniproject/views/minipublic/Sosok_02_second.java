...
public class Sosok_02_second extends JPanel {
	...
	public Sosok_02_second(MainFrame mf, Player123 player) {
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("[사장님! 전국노래자랑 우승하고 왔습니다..!!]", 100, 730);
	...
	class clickButton extends MouseAdapter{  
		...
		public void mouseClicked(MouseEvent e) {
			ChangePanel.changePanel(mf, panel, new Sosok_03_second(mf,player));
			mf.revalidate();
		}
	}
}
