...
public class Sosok_junguk extends JPanel { //소속사 첫화면
   ...
   public Sosok_junguk(MainFrame mf, Player123 player) {
   ...
   public void paintComponent(Graphics g) {
      ...
      g.drawString("사장님: 휼륭하군...! 이렇게 빨리 스킬을 획득하다니...나가서 자네의 꿈을 펼치게", 100, 710);
      g.drawString("밖은 저기있는 파란색 문을 통해 나갈 수 있다네 ", 140, 750);
