...
public class Sosok_01_second extends JPanel { //전국 노래자랑 다녀 온 후 소속사 첫화면
   ...
   public Sosok_01_second(MainFrame mf, Player123 player) {
   ...
   class clickButton extends MouseAdapter{  
      @Override
      public void mouseClicked(MouseEvent e) {
         ChangePanel.changePanel(mf, panel, new Sosok_02_second(mf,player));
         mf.revalidate();
      }
